#!/usr/bin/bash
BenchmarkOutDir=/home/proy/cTool/benchmarks_results/MIC/cmiss_test_Conflict_Capacity_1
...
isSMT=NONSMT
sh getPEBSScript.sh benchmarkListMICTest benchmarkRunCommandMIC8threadsTest $BenchmarkOutDir/NONSMT_NotDynamic $LIBMONITORDIR $ROOTDIR $isSMT

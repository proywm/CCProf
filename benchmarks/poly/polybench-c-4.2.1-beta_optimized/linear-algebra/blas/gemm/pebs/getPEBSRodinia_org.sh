#!/usr/bin/bash
BenchmarkOutDir=/home/proy/cTool/benchmarks_results/rodinia/cmiss_test_7
...
isSMT=NONSMT
sh getPEBSScript.sh benchmarkListRodinia benchmarkRunCommandRodinia8threads $BenchmarkOutDir/NONSMT_NotDynamic $LIBMONITORDIR $ROOTDIR $isSMT

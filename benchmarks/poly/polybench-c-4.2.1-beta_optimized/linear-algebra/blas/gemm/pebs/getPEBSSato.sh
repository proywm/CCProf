#!/usr/bin/bash
BenchmarkOutDir=/home/proy/cTool/benchmarks_results/Sato/cmiss_test_1
...
isSMT=NONSMT
sh getPEBSScript.sh benchmarkListSatoTest benchmarkRunCommandSato8threadsTest $BenchmarkOutDir/NONSMT_NotDynamic $LIBMONITORDIR $ROOTDIR $isSMT

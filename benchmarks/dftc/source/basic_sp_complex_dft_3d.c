...
static void init(MKL_Complex8 *x, int N1, int N2, int N3,
                 int H1, int H2, int H3);
static int verify(MKL_Complex8 *x, int N1, int N2, int N3,
                  int H1, int H2, int H3);
...
int main(void)
{
    ...
    x = (MKL_Complex8*)mkl_malloc(N1*N2*N3*sizeof(MKL_Complex8), 64);
    if (0 == x) goto failed;

...
// Xu Liu
void
_papi_hwi_dummy_handler( int EventSet, void *address, void *data_addr, 
			 unsigned long cpu, unsigned long tid, unsigned long time, unsigned long weight, unsigned long src,

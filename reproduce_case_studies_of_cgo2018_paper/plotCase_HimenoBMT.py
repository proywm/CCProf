...
x = HimenoBMT_Optimized[:,0]
#print x
y1 = HimenoBMT[:,1]
y1_1 = HimenoBMT_Optimized[:,1]
...
ax1.grid(True)
ax1.set_title('HimenoBMT',fontsize=24)
...
#plt.show()
fig.savefig("CCProf_CDF_RCD_HimenoBMT_Figure9.pdf", bbox_inches='tight')
